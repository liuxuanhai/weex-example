...
/***/ (function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/38c0aa8e6745ebe90f97bcf3db64e043', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/38c0aa8e6745ebe90f97bcf3db64e043',undefined,undefined)
	  ...
	  "children": [
	    {
	      ...
	      "attr": {
	        ...
	        "backitemsrc": function () {return this.backSrc},
	        "backitemtitle": function () {return this.backText},
	    ...
	    },
	    {
	      ...
	      "children": [
	        ...
	        },
	        {
	          ...
	          "events": {
	            "click": function ($event) {this.onSecretLever($event)}
	          },
	          "style": {
	            "borderColor": function () {return this.indicatorColor},
	            "height": function () {return this.rowHeight}
	          ...
	          "children": [
	            ...
	            },
	            {
	              ...
	              "attr": {
	                "value": function () {return this.type1}
	              }
	            },
	            {
	              "type": "image",
	        ...
	        },
	        {
	          ...
	          "events": {
	            "click": function ($event) {this.onRecordType($event)}
	          },
	          "children": [
	            {
	              "type": "text",
	            ...
	            },
	            {
	              ...
	              "attr": {
	                "value": function () {return this.type3}
	              }
	            },
	            {
	              "type": "image",
	        ...
	        },
	        {
	          ...
	          "children": [
	            ...
	            },
	            {
	              ...
	              "style": {
	                "fontSize": function () {return this.fontRow},
	                "color": function () {return this.datecolor},
	                "width": 500,
	                "height": 40
	              },
	              "events": {
	                "click": function ($event) {this.pickDate($event)}
	              },
	              "attr": {
	          ...
	          "children": [
	            {
	              ...
	              "style": {
	                ...
	                "borderColor": function () {return this.indicatorColor},
	                "flexDirection": "row",
	                "minHeight": function () {return this.rowHeight}
	              },
	              "children": [
	                {
	                  "type": "text",
	                  ...
	                  "attr": {
	                    "value": function () {return this.selectname}
	                  }
	                }
	              ]
	            }
	        ...
	        },
	        {
	          ...
	          "repeat": {
	            "expression": function () {return this.groupList},
	            "value": "item"
	          },
	          "events": {
	            "click": "onSelect"
	          ...
	          "children": [
	            ...
	            },
	            {
	              ...
	              "shown": function () {return this.groupListSelect[this.$index]}
	            }
	          ]
	        },
	        {
	          ...
	          "shown": function () {return this.isNoGroup},
	          "children": [
	            {
	              "type": "text",
	              "classList": [
	          ...
	          "children": [
	            {
	              "type": "div",
	              "repeat": {
	                "expression": function () {return this.imageScr},
	                "value": "image"
	              },
	              "children": [
	                {
	                  ...
	                  "attr": {
	                    "src": function () {return this.image.imgUrl}
	                  },
	                  "events": {
	                    "longpress": "delDisplay",
	                    "click": "cancaleDel"
	                  }
	                },
	                {
	                  ...
	                  "attr": {
	                    "src": "local://del_image.png"
	                  },
	                  "shown": function () {return this.imageDisplay},
	                  "events": {
	                    "click": "delImage"
	                  }
	                }
	            ...
	            },
	            {
	              ...
	              "shown": function () {return this.addDisplay},
	              "children": [
	                {
	                  "type": "text",
	                  "style": {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    computed: {
	        imageArray: function imageArray() {
	    ...
	    created: function created() {
	        ...
	        var self = this;
	        var Stack1 = new BroadcastChannel('select_level');
	        ...
	        var Stack2 = new BroadcastChannel('select_category');
	        Stack2.onmessage = function (event) {
	            var str = event.data.split(' ');
	            self.type2 = str[0];
	            self.type2Index = str[1];
	        };
	        var Stack3 = new BroadcastChannel('select_recordtype');
	    ...
	    methods: {
	        ...
	        onSecretLever: function onSecretLever() {
	            var vm = this;
	        ...
	        onRecordType: function onRecordType() {
	            var vm = this;
	            var url = this.baseURL;
	            if ((typeof window === 'undefined' ? 'undefined' : (0, _typeof3.default)(window)) !== 'object') {
	        ...
	        getGroupList: function getGroupList(userId, userName) {
	            var json = {
	                attr: {
	        ...
	        renderData: function renderData() {
	            ...
	            service.fetch(json, function (res) {
	                try {
	                    ...
	                    console.log('----groups', (0, _stringify2.default)(res.data.groupList));
	                    if (groups.length == 0) {
	                        self.isNoGroup = true;
	                    }
	                    ...
	                    console.log('---groupList', (0, _stringify2.default)(self.groupList));
	                } catch (e) {}
	            });
	        },
	        ...
	        getphoto: function getphoto(e) {
	            ...
	            var self = this;
	            var photo = __weex_require__('@weex-module/cameraUtils');
	        ...
	        delDisplay: function delDisplay() {
	            this.imageDisplay = true;
	        },

	        cancaleDel: function cancaleDel() {
	            this.imageDisplay = false;
	        },
