...
/***/ (function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/259391f3654c330cefee35cfa1d8ccdd', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/259391f3654c330cefee35cfa1d8ccdd',undefined,undefined)
	              ...
	              "children": [
	                {
	                  ...
	                  "attr": {
	                    "value": function () {return this.personStr}
	                  }
	                }
	              ]
	            }
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "children": [
	                        ...
	                        },
	                        {
	                          ...
	                          "attr": {
	                            "value": function () {return this.item.flowContent}
	                          }
	                        }
	                      ]
	                    },
	                          ...
	                          "children": [
	                            {
	                              ...
	                              "attr": {
	                                "value": function () {return this.item.flowUser}
	                              }
	                            },
	                            {
	                              "type": "text",
	                              ...
	                              "attr": {
	                                "value": function () {return this.item.flowTime}
	                              }
	                            }
	                          ]
	                        }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    methods: {
	        toAnnotation: function toAnnotation(e) {
	            var vm = this;
	        ...
	        getLogInfo: function getLogInfo(docId) {
	            var json = {
	                attr: {
	        ...
	        renderData: function renderData() {
	            ...
	            service.fetch(json, function (res) {
	                try {
	                    ...
	                    console.log("text:" + (0, _stringify2.default)(res));
	                    console.log("results:" + (0, _stringify2.default)(results));
	                    var operation = (0, _stringify2.default)(results.flowLogs);
	                    ...
	                    console.log("userNames:" + (0, _stringify2.default)(userNames));
