...
/***/ (function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/fdc6d718f9fe82c3df67ca349f5f437d', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/fdc6d718f9fe82c3df67ca349f5f437d',undefined,undefined)
	                      ...
	                      "children": [
	                        {
	                          ...
	                          "attr": {
	                            "value": function () {return this.todoItem.title}
	                          }
	                        },
	                        {
	                          "type": "div",
	                          ...
	                          "children": [
	                            {
	                              ...
	                              "attr": {
	                                "value": function () {return this.todoItem.createUser}
	                              }
	                            },
	                            {
	                              "type": "text",
	                              ...
	                              "attr": {
	                                "value": function () {return this.todoItem.fileID}
	                              }
	                            }
	                          ]
	                        }
	                      ...
	                      "children": [
	                        {
	                          ...
	                          "attr": {
	                            "value": function () {return this.todoItem.createDate}
	                          }
	                        }
	                      ]
	                    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var setNavBarHeight = __webpack_require__(4).methods.setNavBarHeight;
	  ...
	  methods: {
	    ...
	    oncellclick: function oncellclick(e) {
	      ...
	      if ((typeof window === 'undefined' ? 'undefined' : (0, _typeof3.default)(window)) !== 'object') {
	        ...
	        url = this.baseURL + 'search-doc/query-result-detail.js?docId=' + docId;
	      }
	      var params = { 'url': url, 'docId': docId };
	      navigator.push(params, function (e) {});
	    },
	    getHQTaskList: function getHQTaskList(userId, userName, strStartDate, strEndDate, strTitle, strDocType, strDocClass, strWriter, strDepartment, strFileId, page) {
	      var json = {
	        attr: {
	          projectName: "1800OAProject",
	          serviceName: "getSearchDoc",
	    ...
	    renderData: function renderData() {
	      ...
	      self.beginTime = tools.getParameterByName("beginTime", bundleUrl);
	      self.endTime = tools.getParameterByName("endTime", bundleUrl);
	      self.fileName = tools.getParameterByName("fileName", bundleUrl);
	      self.fileType = tools.getParameterByName("type1", bundleUrl);
	      self.fileDocument = tools.getParameterByName("type2", bundleUrl);
	      self.fileUser = tools.getParameterByName("user", bundleUrl);
	      self.fileUnit = tools.getParameterByName("unit", bundleUrl);
	      self.fileNumber = tools.getParameterByName("fileNumber", bundleUrl);
	      console.log('qqqqqqqqqqqqqq' + self.beginTime + self.endTime + self.fileName + self.fileType + self.fileDocument + self.fileUser + self.fileUnit + self.fileNumber + this.page.toString());
	      var json = self.getHQTaskList(this.userId, this.userName, self.beginTime, self.endTime, self.fileName, self.fileType, self.fileDocument, self.fileUser, self.fileUnit, self.fileNumber, this.page.toString());

	      var service = __weex_require__('@weex-module/service') || {};
	      service.fetch(json, function (res) {
	        console.log('qqqqqqqqqqqqqq----' + (0, _stringify2.default)(res));
