...
/***/ (function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/f8ad61e7cd5a9eb2ef8cc171af5fa803', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/f8ad61e7cd5a9eb2ef8cc171af5fa803',undefined,undefined)
	          ...
	          "children": [
	            {
	              ...
	              "events": {
	                "click": function ($event) {this.pickDate(0,$event)}
	              },
	              "children": [
	                {
	                  "type": "text",
	                ...
	                },
	                {
	                  ...
	                  "style": {
	                    "color": function () {return this.beginTimeColor}
	                  }
	                },
	                {
	                  "type": "image",
	            ...
	            },
	            {
	              ...
	              "events": {
	                "click": function ($event) {this.pickDate(1,$event)}
	              },
	              "children": [
	                {
	                  "type": "text",
	                ...
	                },
	                {
	                  ...
	                  "style": {
	                    "color": function () {return this.endTimeColor}
	                  },
	                  "attr": {
	                    "value": function () {return this.value2}
	                  }
	                },
	                {
	                  "type": "image",
	            ...
	            },
	            {
	              ...
	              "events": {
	                "click": function ($event) {this.toSelectType($event)}
	              },
	              "children": [
	                {
	                  "type": "text",
	                ...
	                },
	                {
	                  ...
	                  "style": {
	                    "color": function () {return this.typeColor}
	                  },
	                  "attr": {
	            ...
	            },
	            {
	              ...
	              "events": {
	                "click": function ($event) {this.toOfficialDocument($event)}
	              },
	              "children": [
	                {
	                  "type": "text",
	                ...
	                },
	                {
	                  ...
	                  "style": {
	                    "color": function () {return this.documentColor}
	                  },
	                  "attr": {
	                    "value": function () {return this.type2}
	                  }
	                },
	                {
	                  "type": "image",
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    created: function created() {
	        ...
	        var self = this;
	        var Stack = new BroadcastChannel('query_select_type');
	        ...
	        var Stack2 = new BroadcastChannel('query_official_document');
	    ...
	    methods: {
	        ...
	        onInputFileName: function onInputFileName(event) {
	            var self = this;
	            self.fileName = event.value;
	            self.inputNameColor = "#373737";
	        },

	        onInputUser: function onInputUser(event) {
	            this.user = event.value;
	        },

	        onInputUnit: function onInputUnit(event) {
	            this.unit = event.value;
	        },

	        onchangeFileNumber: function onchangeFileNumber(event) {
	        ...
	        toOfficialDocument: function toOfficialDocument() {
	            var url = this.baseURL;
	            if ((typeof window === 'undefined' ? 'undefined' : (0, _typeof3.default)(window)) !== 'object') {
