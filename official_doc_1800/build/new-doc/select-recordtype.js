...
/***/ (function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/894b24c41805991b3042ba2c1f8078fb', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/894b24c41805991b3042ba2c1f8078fb',undefined,undefined)
	      ...
	      "children": [
	        {
	          ...
	          "repeat": {
	            "expression": function () {return this.nextList},
	            "value": "item"
	          },
	          "events": {
	            "click": function ($event) {this.clickSwitch($event)}
	          },
	          "style": {
	            "backgroundColor": "#FFFFFF"
	          },
	          "children": [
	            {
	              ...
	              "attr": {
	                "value": function () {return this.item.operation}
	              }
	            },
	            {
	              "type": "image",
	...
	module.exports = {
	    created: function created() {
	        ...
	        this.$on('naviBar.leftItem.click', function (event) {
	            ...
	            storage.setItem('select_recordtype', this.selectType, function (e) {});
	        ...
	        clickSwitch: function clickSwitch(e) {
	            for (var i = 0; i < this.nextList.length; i++) {
	                if (this.$index == i) {
	                    ...
	                    var Hulk = new BroadcastChannel('select_recordtype');
