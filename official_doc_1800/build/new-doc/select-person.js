...
/***/ (function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/7201971d9b3da7bedecbeb357d4c1103', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/7201971d9b3da7bedecbeb357d4c1103',undefined,undefined)
...
/***/ (function(module, exports) {
	...
	module.exports = {
	  ...
	  "style": {
	    ...
	    "backgroundColor": function () {return this.bcolor},
	    "justifyContent": "center"
	  },
	  "children": [
	    {
	      "type": "div",
	      "style": {
	        "height": function () {return this.navBarHeight-this.navHeight},
	        "backgroundColor": function () {return this.bcolor}
	      },
	    ...
	    },
	    {
	      "type": "div",
	      "style": {
	        "height": function () {return this.navHeight},
	        "flexDirection": "row",
	              ...
	              "children": [
	                {
	                  ...
	                  "style": {
	                    ...
	                    "width": 119,
	                    "height": 46,
	                    "backgroundColor": function () {return this.leftbgcolor},
	                  ...
	                  "attr": {
	                    "value": function () {return this.todotitle}
	                  }
	                },
	                {
	                  "type": "text",
	                  "style": {
	                    ...
	                    "width": 117,
	                    "height": 46,
	                    "backgroundColor": function () {return this.rightbgcolor},
	                  ...
	                  "attr": {
	                    "value": function () {return this.donetitle}
	                  }
	                }
	              ]
	            }
	          ...
	          "children": [
	            {
	              ...
	              "shown": function () {return this.rightimage}
	            },
	            {
	              "type": "div",
	              "style": {
	              ...
	              "shown": function () {return this.righttitle},
	              "children": [
	                {
	                  "type": "text",
	                  "style": {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        todoselect: function todoselect() {
	        ...
	        doneselect: function doneselect() {
	  ...
	  "children": [
	    {
	      ...
	      "attr": {
	        "height": function () {return this.navBarHeight},
	        "leftimage": "local://back_button.png",
	        "bcolor": function () {return this.bcolor},
	        "todotitle": "待选",
	        "donetitle": "已选",
	        "leftcolor": function () {return this.leftcolor},
	        "rightcolor": function () {return this.rightcolor},
	        "leftbgcolor": function () {return this.leftbgcolor},
	        "rightbgcolor": function () {return this.rightbgcolor},
	        "lefttitle": function () {return this.lefttitle}
	      }
	    },
	    {
	      "type": "scroller",
	      "shown": function () {return this.daixuanisplay},
	      "append": "tree",
	      "children": [
	        {
	          "type": "div",
	          ...
	          "children": [
	            {
	              ...
	              "events": {
	                "click": function ($event) {this.personList(this.item.deptFullName,$event)}
	              },
	              "style": {
	                "backgroundColor": "#FFFFFF"
	              },
	              "children": [
	                {
	                  ...
	                  "attr": {
	                    "value": function () {return this.changeText(this.item.deptFullName)}
	                  }
	                },
	                {
	                  "type": "image",
	    ...
	    {
	      "type": "scroller",
	      "shown": function () {return this.yixuanisplay},
	      "append": "tree",
	      "children": [
	        {
	          "type": "div",
	          "repeat": {
	            "expression": function () {return this.selectedPerson},
	            "value": "item"
	          },
	          "children": [
	            {
	              ...
	              "events": {
	                "click": function ($event) {this.deleteperson(this.item,$event)}
	              },
	              "style": {
	                "backgroundColor": "#FFFFFF"
	              },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getBaseURL = __webpack_require__(140).getBaseURL;
	var getParameterByName = __webpack_require__(4).methods.getParameterByName;
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        personList: function personList(mydeptName, e) {
	            var vm = this;
	        ...
	        deleteperson: function deleteperson(item, e) {
	            var self = this;
	            ...
	            storage.setItem('person-list', (0, _stringify2.default)(self.selectedPerson), function (e) {});
	        },
	        getOrgInfo: function getOrgInfo(userId, userName) {
	            var json = {
	                attr: {
	        ...
	        renderData: function renderData() {
	            ...
	            var json = self.getOrgInfo(self.userId, self.userName);
	        ...
	        setNavBarState: function setNavBarState(hidden) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/search-navbar', [], function(__weex_require__, __weex_exports__, __weex_module__) {
