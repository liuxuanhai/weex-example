...
/***/ (function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/1af563329d836d6066eb975fed3d7781', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/1af563329d836d6066eb975fed3d7781',undefined,undefined)
	  ...
	  "children": [
	    {
	      ...
	      "attr": {
	        ...
	        "rightbuttons": function () {return this.rightbuttons},
	                          ...
	                          "children": [
	                            {
	                              ...
	                              "attr": {
	                                "src": "local://todo_list_mine_icon.png"
	                              }
	                            }
	                          ]
	                        },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getBaseURL = __webpack_require__(148).getBaseURL;
	module.exports = {
	  created: function created() {
	  ...
	  methods: (_methods = {
	  ...
	  }, (0, _defineProperty3.default)(_methods, 'onchange', function onchange(e) {
	    this.goto(parseInt(e.index));
	  }), (0, _defineProperty3.default)(_methods, 'oncellclick', function oncellclick(e) {
	    var vm = this;
	  ...
	  }), (0, _defineProperty3.default)(_methods, 'getHQTaskList', function getHQTaskList(userName, userId, page) {
	    var json = {
	      attr: {
	    ...
	    return json;
	  }), (0, _defineProperty3.default)(_methods, 'renderData', function renderData(page) {
	    var self = this;
	    self.items.length = 0;
	    var json = self.getHQTaskList("罗文钦", "045089", page + "");
	    service.fetch(json, function (res) {
	      self.loadingDisplay = 'hide';
	      try {
	        var docs = res.data.docs || [];
	        console.log('get docs', (0, _stringify2.default)(res.data.docs));
	  ...
	  }), (0, _defineProperty3.default)(_methods, 'getSecondDate', function getSecondDate() {
	    var self = this;
	    self.items.length = 0;
	    self.items.push({ "title": "批注时间",
	      "fileID": "会议纪要20170134",
	      "createUser": "技术",
	      "createDate": "2017-06-08",
	      "documentKey": "BF169F9771E2C5C048258100000568BC" });
	    self.isLoaded = true;
	  }), (0, _defineProperty3.default)(_methods, 'loadingData', function loadingData(e) {
	    var self = this;
	    ...
	    if (this.index == 0) {
	      self.renderData(self.page);
	    } else {
	      self.getSecondDate(self.page);
	    }
	  }), (0, _defineProperty3.default)(_methods, 'onrefresh', function onrefresh(e) {
	    var self = this;
